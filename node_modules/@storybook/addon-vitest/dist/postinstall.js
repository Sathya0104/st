import CJS_COMPAT_NODE_URL_9khatii9pbh from 'node:url';
import CJS_COMPAT_NODE_PATH_9khatii9pbh from 'node:path';
import CJS_COMPAT_NODE_MODULE_9khatii9pbh from "node:module";

var __filename = CJS_COMPAT_NODE_URL_9khatii9pbh.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_9khatii9pbh.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_9khatii9pbh.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-Q3GYZMVS.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-WY57UL6N.js";
import {
  require_dist
} from "./_node-chunks/chunk-XGGDWU77.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-5XDA3IYU.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-HY3T3XTP.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-MDMOSM7U.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-FY5AMWTR.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-WZ4EYXGO.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-7HLUHHOK.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-6OC3AR2E.js");
    default:
